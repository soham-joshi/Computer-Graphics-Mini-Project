...
// SKYBOX/FOG
var materialArray = [];
materialArray.push(new THREE.MeshBasicMaterial( { map:( './Blender Models/dawnmountain-xneg.png' ) }));
materialArray.push(new THREE.MeshBasicMaterial( { map: Texture_loader.load( './Blender Models/dawnmountain-xpos.png' ) }));
materialArray.push(new THREE.MeshBasicMaterial( { map: Texture_loader.load( './Blender Models/dawnmountain-ypos.png' ) }));
materialArray.push(new THREE.MeshBasicMaterial( { map:Texture_loader.load( './Blender Models/dawnmountain-yneg.png' ) }));
materialArray.push(new THREE.MeshBasicMaterial( { map: Texture_loader.load( './Blender Models/dawnmountain-zpos.png' ) }));
materialArray.push(new THREE.MeshBasicMaterial( { map: Texture_loader.load( './Blender Models/dawnmountain-zneg.png' ) }));
for (var i = 0; i < 6; i++)
...
var building_texture=Texture_loader.load('./blender_models/creeper.png');
	...
	uv_planar(buildingGeometry,buildingMesh);
	scene.add(buildingMesh);
